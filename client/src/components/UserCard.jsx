    ...
    >
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className="w-full py-2 rounded-md flex justify-center items-center gap-2 bg-sky-500 hover:bg-sky-600 active:scale-95 transition text-white cursor-pointer"
        >
