        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    ...
                    alt=""
                    className="w-80 h-40 rounded-lg bg-gradient-to-r from-sky-200 via-emerald-200 to-pink-200 object-cover mt-2"
                  />
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button type="submit" className="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition cursor-pointer">
                Save Changes
              </button>
            </div>
          </form>
