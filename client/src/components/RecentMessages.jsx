...
const RecentMessages = () => {
  ...
  const fetchRecentMessages = async () => {
    try {
      ...
      if (data.success) {
        // Group messeges by sender and get the latest message for each sender
  ...
  return (
    <div className="bg-white max-w-xs mt-4 p-4 min-h-20 rounded-md shadow text-xs text-slate-800">
      ...
      <div className="flex flex-col max-h-56 overlow-y-scroll no-scrollbar">
          ...
          >
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between">
                ...
                {!message.seen && (
                  <p className="bg-sky-500 text-white w-4 h-4 flex items-center justify-center rounded-full text-[10px]">
                    1
                  </p>
                )}
              </div>
